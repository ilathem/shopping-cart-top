...
describe('Product component UI', () => {
  ...
  it('contains form for updating quantity, increment and decrement buttons, and submit', () => {
    ...
    expect(screen.getByRole('button', { name: 'quantity-increment' }).textContent).toMatch('+1');
    expect(screen.getByRole('button', { name: 'quantity-decrement' }).textContent).toMatch('-1');
